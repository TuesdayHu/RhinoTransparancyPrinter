...
namespace TransparencyPrinter
{
    ...
    ///</summary>
    public class TransparencyPrinterPlugin : Rhino.PlugIns.FileExportPlugIn
    {
        public TransparencyPrinterPlugin()
        {
            Instance = this;
        }

        ///<summary>Gets the only instance of the TransparencyPrinterPlugin plug-in.</summary>
        public static TransparencyPrinterPlugin Instance { get; private set; }
        ...
        protected override Rhino.PlugIns.FileTypeList AddFileTypes(Rhino.FileIO.FileWriteOptions options)
        {
            ...
            result.AddFileType("Print Image (*.png)", "png");
            return result;
        }

        /// <summary>
        /// Is called when a user requests to export a .png file.
